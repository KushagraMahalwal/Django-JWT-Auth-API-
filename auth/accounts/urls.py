...
urlpatterns = [
    ...
    path('changepass/',UserChangePasswordView.as_view(),name='userchangepassword'),
    path('send-reset-passwordemail/', SendPasswordResetEmailView.as_view(), name='send-reset-password-email'),
